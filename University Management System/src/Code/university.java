...
public class university {
    university(){
     JFrame frame = new JFrame("Khaqan Institiue of Technology");
        ...
        ImageIcon image1 = new ImageIcon("src/uni2.jpg");
        ...
        label1.setBorder(border);
         ...
         ImageIcon image2 = new ImageIcon("src/uni5.png");
        ...
        label2.setBorder(border1);
         ...
         ImageIcon image3 = new ImageIcon("src/uni3.jpg");
        ...
        label3.setBorder(border3);
         ...
         ImageIcon image4 = new ImageIcon("src/uni4.jpg");
        ...
        label4.setBorder(border4);
         ...
         ImageIcon image5 = new ImageIcon("src/uni1.jpg");
        ...
        label5.setBorder(border5);
         ...
         ImageIcon image6 = new ImageIcon("src/uni6.jpg");
